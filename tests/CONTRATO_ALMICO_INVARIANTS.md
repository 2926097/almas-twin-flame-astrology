# Invariantes · Contrato álmico

1. El contrato álmico no es una quinta categoría AF/KA/AG/LG.
2. Ninguna cláusula puede existir sólo por un asteroide, Vertex, atacir o tránsito.
3. Toda cláusula debe apuntar al menos a una raíz estructural normalizada.
4. A_EN_B y B_EN_A se calculan por separado.
5. Bilateral no significa simétrico.
6. La compuesta y Davison no duplican independencia.
7. La dracónica no duplica automáticamente la sinastría tropical.
8. La temporalidad no crea cláusulas: activa cláusulas preexistentes.
9. La firma de cumplimiento debe definirse antes de evaluar el evento usado para comprobarla.
