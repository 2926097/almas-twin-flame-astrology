...
def analyze_precomputed(payload: Mapping[str, Any]) -> dict[str, Any]:
    """Analiza valores de pilares ALMAS ya calculados.
    ...
    results: dict[str, Any] = {
        "public_version": "1.10.2",
        "input_mode": "PRECOMPUTED_PILLARS",
        "models": {},
        "pairwise_idd": {},
        "limitations": [
            "Esta salida no calcula astronomía, aspectos, raíces, modelos nulos ni temporalidad.",
            "Las puntuaciones de modelo son índices de compatibilidad estructural, no probabilidades metafísicas.",
        ],
    }
