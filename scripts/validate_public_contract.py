...
def main() -> int:
    ...
    if preincarnation_schema.get("properties", {}).get("schema_version", {}).get("const") != "1.2.0":
        fail("preincarnation reconstruction schema must expose schema_version 1.2.0")
    ...
    if preincarnation_example.get("schema_version") != "1.2.0":
        fail("synthetic preincarnation example must use schema_version 1.2.0")
